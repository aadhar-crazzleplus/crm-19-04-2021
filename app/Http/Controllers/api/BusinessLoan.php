...
class BusinessLoan extends BaseController
{
    ...
    public function addbl_profile(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'full_name' => 'required',
            'mobile_no' => 'required|min:10|max:10',
    ...
    public function addbl_is_loan(Request $request)
    {
        ...
        $arr_inocome=array();
        if(!empty($res_arr) && $res_arr->itr_amount != ""){
    ...
    public function addbl_income(Request $request)
    {

        $validator = Validator::make($request->all(), [
            'itr_amount' => 'required',
            'gst_no' => 'required',
            'gst_vintage' => 'required',
            'company_id' => 'required',
