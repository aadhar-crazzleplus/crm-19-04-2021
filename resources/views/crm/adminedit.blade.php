...
<div class="col-md-10 col-xs-12">
    ...
    <div class="box-content">
        ...
        <form id="commentForm" action="{{ route('update-admin',$users->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tabsleft-tab2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                @endphp
                            <input type="file" data-default-file="{{asset('storage/admins/'.$users->id.'/'.$upload_doc)}}" id="upload_doc" name="upload_doc" class="dropify" data-max-file-size="20M" data-max-height="2000" />
                    ...
                    <div class="tab-pane" id="tabsleft-tab3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="file" data-default-file="{{asset('storage/admins/'.$users->id.'/'.$users->upload_qual_doc)}}" id="upload_qual_doc" name="upload_qual_doc" class="dropify" data-max-file-size="20M" data-max-height="2000" />
                    <p class="help margin-top-10">Only portrait or square images, 20M max and 2000px max-height.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane" id="tabsleft-tab5">
                        ...
                        <div class="form-group">
                            ...
                            @endphp
                                <input type="file" data-default-file="{{asset('storage/admins/'.$users->id.'/'.$id_doc_front)}}" id="id_doc_front" name="id_doc_front" class="dropify" data-max-file-size="20M" data-max-height="2000" />
                    <p class="help margin-top-10">Only portrait or square images, 20M max and 2000px max-height.</p>
                            </div>
                            <div class="controls">
                                <input type="file" data-default-file="{{asset('storage/admins/'.$users->id.'/'.$id_doc_back)}}" id="id_doc_back" name="id_doc_back" class="dropify" data-max-file-size="20M" data-max-height="2000" />
                    <p class="help margin-top-10">Only portrait or square images, 20M max and 2000px max-height.</p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="file" data-default-file="{{asset('storage/admins/'.$users->id.'/'.$users->upload_pan_no)}}" id="upload_pan_no" name="upload_pan_no" class="dropify" data-max-file-size="20M" data-max-height="2000" />
                    <p class="help margin-top-10">Only portrait or square images, 20M max and 2000px max-height.</p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="file" data-default-file="{{asset('storage/admins/'.$users->id.'/'.$users->upload_gst_no)}}" id="upload_gst_no" name="upload_gst_no" class="dropify" data-max-file-size="20M" data-max-height="2000" />
                    <p class="help margin-top-10">Only portrait or square images, 20M max and 2000px max-height.</p>
                            </div>
                        </div>
