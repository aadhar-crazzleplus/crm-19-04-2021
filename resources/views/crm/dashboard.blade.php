...
<?php 
    ...
    // $sessionArray['userDetails']['user_type']
...
<?php 
            ...
            <script>
                swal({
                    title: "Opps! No Permission!!",
                    text: "You don't have any permissions contact superadmin!",
                    type: "warning",
                ...
                function(willLogout){
                    if (willLogout) {
                        swal("Success!", "You are about to be logged out.", "success");
                        setTimeout(function () {
                            window.location = 'logout';
                        }, 2000);
                    } else {
                        swal("Please logout & login again after the permissions have been assigned.");
                    }
                });
            </script>
<?php
...
?>
    <script>
        swal("Opps!", "Something went worng. Please logout & login again!", "warning");
    </script>
<?php
    }
?>
