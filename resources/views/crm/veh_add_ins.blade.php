...
<div class="col-md-10 col-xs-12">
    ...
    <div class="box-content">
        <h4 class="box-title">Add Vehicle Insurance Lead</h4>
        <!-- /.box-title -->
        <div class="dropdown js__drop_down">
            <a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
            <ul class="sub-menu">
                <li><a href="{{route('vehicle-ins')}}">All Vehicle Insurance Leads</a></li>
                    <li><a href="{{route('veh-add-ins')}}">Add Vehicle Insurance</a></li>
                    <li><a href="{{route('veh-del-ins')}}">Deleted Vehicle Insurance</a></li>
            </ul>
            <!-- /.sub-menu -->
        </div>
        <!-- /.dropdown js__dropdown -->
        <form id="commentForm" action="{{ route('veh-store-ins') }}" method="POST" enctype="multipart/form-data" autocomplete="off">

            @csrf
            <div id="tabsleft" class="tabbable tabs-left">
                <ul>
                    <li><a href="#tabsleft-tab1" data-toggle="tab">Registration Details</a></li>
                    <li><a href="#tabsleft-tab2" data-toggle="tab">Vehicle Details</a></li>
