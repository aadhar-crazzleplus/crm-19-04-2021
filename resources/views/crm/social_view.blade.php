    ...
    <div class="col-xs-12">
        <div class="box-content">
            ...
            <div class="dropdown js__drop_down">
                ...
                <ul class="sub-menu">
                    <li><a href="{{route('social-view')}}">All</a></li>
...
function editSocialCard(edit_route){
    $.ajax({
        url:edit_route,
        type: "GET",
        // data: {
        ...
        success: function(result){
            ...
            $("#social_id").val(result.data.id);
            $("#cat_rel_id").val(result.data.cat_rel_id);
            $("#edit_cat_id").val(result.data.cat_id).trigger('change');
...
function showSocialCard(id){
    $.ajax({
        url:"{{route('social-show')}}",
        type: "POST",
        data: {
            id:id,
            _token: '{{csrf_token()}}'
        ...
        dataType : 'json',
        success: function(result){
            $("#show_cat_title").html(result.data.cat_title);
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
           <div class="modal-content">
              <div class="modal-header">
                 ...
                 <h4 class="modal-title" id="myModalLabel">Add Social Card</h4>
              </div>
                    ...
                    <fieldset style="display: block;">
                       ...
                       <div class="form-bottom">
                          <div class="form-group">
                             ...
                             <div class="controls">
                                <select class=" form-control occupation_id select2_1" name="cat_id" id="cat_id">
                          ...
                          <div class="form-group">
                             ...
                             <div class="controls">
                                ...
                                <p class="help margin-top-10">Only square images, 20M max and 2000px max-height.</p>
                            </div>
                          </div>
              ...
              <div class="modal-footer">
                 ...
                 <button type="button" id="next1" data-form="form1" data-route="{{ route('social-add') }}" class="btn btn-default regu btn-next">Submit</button>
        ...
        <div class="modal-dialog  modal-dialog-scrollable" role="document" style="position: relative; overflow-y: auto; height:600px;">
           <div class="modal-content">
              <div class="modal-header">
                 ...
                 <h4 class="modal-title" id="editModalLabel">Social Card Update</h4>
              </div>
              <div class="modal-body">
                <form id="edit_form1" action="" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" id="edit_id" value="" />
                    <input type="hidden" name="cat_rel_id" id="cat_rel_id" value="" />
                 ...
                 <fieldset>
                       ...
                       <div class="form-bottom">
                        <div class="form-group">
                            <label for="cat_id">Category</label>
                            <div class="controls">
                               <select class=" form-control occupation_id select2_1" name="cat_id" id="edit_cat_id">
                                   @foreach ($categories as $category)
                                   <option value="{{$category->id}}">{{$category->title}}</option>
                                   @endforeach
                               </select>
              ...
              <div class="modal-footer">
                 ...
                 <button type="button" id="edit_next1" data-form="edit_form1" data-route="{{ route('social-update') }}" class="btn btn-default regu btn-next">Submit</button>
                 {{-- <button type="button" class="btn btn-default vhclose" data-dismiss="modal">Close</button> --}}
                 <button type="button" class="btn btn-default processing" data-dismiss="modal">Processing please wait.....</button>
              </div>
           </div>
     ...
     <div class="modal fade bd-example-modal-lg" id="showModal1" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document" style="position: relative; overflow-y: auto; height:600px;">
           <div class="modal-content">
              <div class="modal-header">
                 <button type="button" class="close vhclose" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                 <h4 class="modal-title" id="showModalLabel">Social Card Details: <span id="show_product_title"></span></h4>
              </div>
              <div class="modal-body">

                <div class="box-content card">
                    <h4 class="box-title"><i class="fa fa-envira ico"></i>Social Card Details</h4>

                    <div class="card-content">
                        <div class="row">
                            <div class="col-md-6 list-group-item">
                                <div class="row">
                                    <div class="col-xs-5"><label>Category:</label></div>
                                    <!-- /.col-xs-5 -->
                                    <div class="col-xs-7" id="show_cat_title"></div>
                                    <!-- /.col-xs-7 -->
                                </div>
                                <!-- /.row -->
                            </div>
